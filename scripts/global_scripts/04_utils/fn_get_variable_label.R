...
#' Uses the variable_chinese_labels.yaml configuration file.
#' 
...
get_variable_label <- function(var_names, 
  ...
  if (is.null(config_path)) {
    ...
    possible_paths <- c(
      "scripts/global_scripts/global_data/parameters/scd_type2/variable_chinese_labels.yaml",
      "global_scripts/global_data/parameters/scd_type2/variable_chinese_labels.yaml",
      "global_data/parameters/scd_type2/variable_chinese_labels.yaml",
      "../global_data/parameters/scd_type2/variable_chinese_labels.yaml",
      "../../global_data/parameters/scd_type2/variable_chinese_labels.yaml",
    ...
    if (is.null(config_path)) {
      warning("Could not find variable_chinese_labels.yaml. Returning original names.")
      return(var_names)
    }
  }
