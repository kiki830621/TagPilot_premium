...
#' list_covariate_neglected.yaml. Supports exact matches, regex patterns,
...
#'        (default: "global_data/parameters/scd_type2/list_covariate_neglected.yaml").
...
filter_covariates <- function(data = NULL, 
  ...
  if (is.null(config_path)) {
    ...
    possible_paths <- c(
      "scripts/global_scripts/global_data/parameters/scd_type2/list_covariate_neglected.yaml",
      "global_scripts/global_data/parameters/scd_type2/list_covariate_neglected.yaml",
      "global_data/parameters/scd_type2/list_covariate_neglected.yaml",
      "../global_data/parameters/scd_type2/list_covariate_neglected.yaml",  # From 04_utils directory
      "../../global_data/parameters/scd_type2/list_covariate_neglected.yaml",  # From sub-subdirectories
      file.path(Sys.getenv("APP_ROOT", "."), "scripts/global_scripts/global_data/parameters/scd_type2/list_covariate_neglected.yaml")
    )
    ...
    if (is.null(config_path)) {
      warning("Could not find list_covariate_neglected.yaml. No variables will be excluded.")
