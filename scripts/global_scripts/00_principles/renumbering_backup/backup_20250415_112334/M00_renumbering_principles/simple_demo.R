#' Simple Demonstration of M00_renumbering_principles module
#'
...
cat("===== M00_renumbering_principles Module Demo =====\n\n")
...
cat("----------------------------------------\n")
cat("M00_renumbering_principles$renumber(\"P16\", \"P07\", \"app_bottom_up_construction\")\n\n")
...
cat(")\n\n")
cat("M00_renumbering_principles$batch_renumber(mapping_table)\n\n")
...
cat("------------------------------------\n")
cat("issues <- M00_renumbering_principles$verify()\n")
