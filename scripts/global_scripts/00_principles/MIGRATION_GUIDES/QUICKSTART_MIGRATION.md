...
mkdir -p global_scripts/00_principles_local/natural/en/part1_principles
...
- `natural/en/part1_principles/CH08-CH17/`: Project-specific principle chapters
...
mkdir -p global_scripts/00_principles_local/natural/en/part1_principles/CH08_your_domain

# Create a sample principle
cat > global_scripts/00_principles_local/natural/en/part1_principles/CH08_your_domain/CH08_P001_sample_principle_local.md << 'EOF'
...
1. **Read Core Principles**: Review CH00-CH07 in `global_scripts/00_principles/natural/en/part1_principles/`
...
mkdir -p global_scripts/00_principles_local/natural/en/part1_principles/CH08_shiny_applications
mkdir -p global_scripts/00_principles_local/natural/en/part1_principles/CH09_etl_pipelines
mkdir -p global_scripts/00_principles_local/natural/en/part1_principles/CH10_marketing_analytics
...
mkdir -p global_scripts/00_principles_local/natural/en/part1_principles/CH08_statistical_analysis
mkdir -p global_scripts/00_principles_local/natural/en/part1_principles/CH09_psychometrics
mkdir -p global_scripts/00_principles_local/natural/en/part1_principles/CH10_academic_reporting
...
mkdir -p global_scripts/00_principles_local/natural/en/part1_principles/CH08_python_packaging
mkdir -p global_scripts/00_principles_local/natural/en/part1_principles/CH09_data_processing
