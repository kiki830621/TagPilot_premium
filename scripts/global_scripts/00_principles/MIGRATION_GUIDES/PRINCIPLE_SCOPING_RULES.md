...
# File: 00_principles_local/natural/en/part1_principles/CH02_data_management/override.md
---
...
# File: 00_principles_local/natural/en/part1_principles/CH08_statistical_analysis/CH08_P001_data_loading.md
...
2. **Identify Applicable Core Principles**:
   - Check `00_principles/natural/en/part1_principles/`
   - Review CH00-CH07 for relevant principles

3. **Check Local Extensions**:
   - Check `00_principles_local/natural/en/part1_principles/`
...
vim global_scripts/00_principles_local/natural/en/part1_principles/CH08_shiny_applications/...
