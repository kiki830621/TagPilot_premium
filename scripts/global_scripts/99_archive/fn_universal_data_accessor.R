...
#' mock_data.duckdb database located in global_scripts/global_data directory.
...
#'   the standard path in global_scripts/global_data/mock_data.duckdb will be used.
#'
...
#' db_path <- file.path(root_dir, "update_scripts", "global_scripts", "global_data", "mock_data.duckdb")
#'
#' @keywords internal
