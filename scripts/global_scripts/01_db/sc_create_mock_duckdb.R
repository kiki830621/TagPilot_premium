...
# 
# Script to initialize a DuckDB database file in 'global_scripts/global_data'
# with sample tables for testing and development.
#
# NOTES:
# - This script creates a mock database with test data for development
# - The database is placed in the global_data directory for shared access
...
# This will create 'mock_data.duckdb' in the global_data directory
