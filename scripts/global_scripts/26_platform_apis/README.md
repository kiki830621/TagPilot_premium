...
## Platform Codes (MP092)

| Code | Platform | Data Source | Status |
|------|----------|-------------|---------|
...
# Get data from any platform using platform code
...
1. Create platform directory: `mkdir -p {platform_code}/tests`
2. Create `api_config.yaml` from template
3. Implement required functions:
   - `fn_{code}_connect.R`
   - `fn_{code}_disconnect.R`
   - `fn_{code}_authenticate.R`
   - `fn_{code}_get_{object}.R`
...
- [MP094: Platform API Architecture](../00_principles/natural/en/part1_principles/CH00_fundamental_principles/04_data_management/MP094_platform_api_architecture.qmd)
- [MP092: Platform Code Standard](../00_principles/natural/en/part1_principles/CH00_fundamental_principles/04_data_management/MP092_platform_code_standard.qmd)
- [MG01: Platform API Migration Guide](../00_principles/natural/en/part2_implementations/CH14_migration_guides/MG01_platform_api_migration.qmd)
