...
test_mock_db <- function() {
  ...
  mock_db_path <- "/Users/che/Library/CloudStorage/Dropbox/precision_marketing/precision_marketing_MAMBA/precision_marketing_app/update_scripts/global_scripts/global_data/mock_data.duckdb"
