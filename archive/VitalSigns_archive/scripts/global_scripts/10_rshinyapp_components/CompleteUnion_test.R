...
ui <- bs4Dash::dashboardPage(
  ...
  sidebar = bs4Dash::dashboardSidebar(
    ...
    # Add sidebarMenu for navigation - this connects with tabItems
    bs4Dash::sidebarMenu(
      id = "navbar_menu",
      bs4Dash::menuItem(
        text = "RFM Analysis",
  ...
  # Main body with tabItems for content
  body = bs4Dash::dashboardBody(
    ...
    # This is the correct way to use tabItems in bs4Dash
    bs4Dash::tabItems(
      # RFM Analysis tab
      bs4Dash::tabItem(
        tabName = "rfm",
...
server <- function(input, output, session) {
  ...
  observe({
    ...
    isolate({
      ...
      # bs4Dash::updateTabItems(session, inputId = "navbar_menu", selected = default_tab)
