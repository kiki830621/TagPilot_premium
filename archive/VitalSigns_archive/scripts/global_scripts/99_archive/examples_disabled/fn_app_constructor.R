...
#'   \itemize{
#'     \item title: App title string
#'     \item sections: Vector of section names to include
#'     \item components: Named list mapping sections to components
#'     \item data_sources: Vector of data source names to load
#'     \item layout: Layout type (navbar, sidebar, fillable)
#'     \item theme: Optional theme settings
#'   }
#'
