  ...
  templates <- list(
    ...
    "product_sales" = "
      ...
      FROM 
        %products_table% p
      JOIN 
        %order_items_table% oi ON p.product_id = oi.product_id
      JOIN 
  ...
  if(platform == "06") {  # eBay
    ebay_templates <- list(
      ...
      "customer_orders" = "
        ...
        JOIN 
          eBay_Sales.dbo.OrderItems oi ON o.OrderID = oi.OrderID
        JOIN 
      ...
      "product_sales" = "
        ...
        JOIN 
          eBay_Sales.dbo.OrderItems oi ON p.ProductID = oi.ProductID
        JOIN 
