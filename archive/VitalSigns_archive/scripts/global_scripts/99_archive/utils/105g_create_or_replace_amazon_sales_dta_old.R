create_or_replace_amazon_sales_dta <- function(con) {
  ...
  create_table_sql <- "
    CREATE OR REPLACE TABLE amazon_sales_dta (
      ...
      shipment_id VARCHAR,
      shipment_item_id VARCHAR,
      amazon_order_item_id VARCHAR,
      ...
      PRIMARY KEY (amazon_order_id, shipment_id, shipment_item_id, amazon_order_item_id)
    );
  "
